          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <Section key={i} delay={i * 100}>
                <div className="relative p-8 rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] hover:border-[rgba(232,86,0,0.2)] transition-all duration-300 h-full group overflow-hidden">
                  ...
                  <div className="relative z-10">
                    {/* Icon */}
                    <div className="w-14 h-14 rounded-2xl bg-accent-orange/10 border border-accent-orange/20 flex items-center justify-center mb-6">
                      {f.icon}
                    </div>
        ...
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
            {integrations.map((item, i) => (
              <Section key={i} delay={i * 40}>
                <div className="flex flex-col items-center gap-3 p-4 rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] hover:border-accent-orange/20 hover:bg-[rgba(255,255,255,0.03)] transition-all duration-300">
