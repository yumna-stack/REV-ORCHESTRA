        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal variants={fadeLeft} className="flex flex-col gap-6">
            <div className="relative inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[rgb(25,27,31)] border border-[rgba(255,255,255,0.08)] w-fit">
              ...
              <span className="text-xs text-[rgba(255,255,255,0.6)] tracking-wider">Our Impact</span>
            </div>
            <h2 className="text-[clamp(28px,4vw,48px)] font-medium leading-[115%] tracking-[-2px] text-white">The Numbers Behind Rev Orchestra</h2>
            <p className="text-base text-[rgba(255,255,255,0.45)] leading-[170%]">Real results from AI-orchestrated GTM systems built for B2B founders.</p>
