      ...
      <div className="max-w-[1200px] mx-auto px-5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <div className="flex items-center">
                <div className="flex -space-x-2">
                  {[0, 1, 2, 3].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-[rgb(14,15,17)]" style={{ background: `linear-gradient(135deg, hsl(${i * 40 + 200}, 10%, ${30 + i * 10}%), hsl(${i * 40 + 200}, 10%, ${50 + i * 8}%))` }} />
                  ))}
                </div>
          ...
          <div className="relative" style={{ height: "420px" }}>
                ...
                <div className="relative px-8 pt-6 pb-16" style={{ background: "linear-gradient(180deg, rgba(100,80,180,0.12) 0%, rgba(14,15,17,1) 100%)" }}>
                  ...
                  <div className="flex items-center justify-between mb-3 relative z-10">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="w-6 h-6 rounded-full border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] flex items-center justify-center"><span className="text-[10px]">⚡</span></div>
                    </div>
                  </div>
                  <span className="text-[72px] font-medium leading-none tracking-[-2px] relative z-10 block" style={{ color: "#9897FF" }}>2 Million</span>
                </div>
              </div>
            </motion.div>

            {/* Card 2 */}
            <motion.div className="absolute top-[100px] left-0 right-0 z-[2]" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={cardSlide(0.45)}>
              <div className="rounded-[36px] overflow-hidden" style={{ border: "1px solid rgba(41,42,43,1)", boxShadow: "0 -10px 40px rgba(0,0,0,0.5)" }}>
                <div className="relative px-8 pt-6 pb-16" style={{ background: "linear-gradient(180deg, rgba(14,15,17,1) 0%, rgba(14,15,17,1) 60%, rgba(232,86,0,0.08) 100%)" }}>
                  ...
                  <span className="text-[72px] font-medium leading-none tracking-[-2px] relative z-10 block" style={{ color: "#E85600" }}>12+</span>
            ...
            {/* Card 3 */}
            <motion.div className="absolute top-[230px] left-0 right-0 z-[3]" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={cardSlide(0.7)}>
              <div className="rounded-[36px] overflow-hidden" style={{ border: "1px solid rgba(41,42,43,1)", boxShadow: "0 -10px 40px rgba(0,0,0,0.5)" }}>
                <div className="relative px-8 pt-6 pb-10" style={{ background: "linear-gradient(180deg, rgba(30,30,30,0.5) 0%, rgba(14,15,17,1) 100%)" }}>
                  ...
                  <span className="text-[72px] font-medium leading-none tracking-[-2px] relative z-10 block" style={{ color: "rgba(255,255,255,0.15)" }}>2300+</span>
                </div>
              </div>
            </motion.div>
          </div>
