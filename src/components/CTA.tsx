        ...
        <div className="max-w-[1200px] mx-auto px-5">
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_auto_1fr] gap-8 items-center">
            ...
            <Reveal variants={fadeUp} delay={0.1}>
              <div className="rounded-[24px] overflow-hidden w-[200px] h-[200px] relative shrink-0">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <motion.div
                    className="w-16 h-16 rounded-2xl bg-[rgba(0,0,0,0.45)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center shadow-2xl"
                    animate={{ y: [0, -5, 0] }}
            ...
            <Reveal variants={fadeUp} delay={0.2}>
              <div className="rounded-[24px] bg-[rgb(14,15,17)] border border-[rgb(41,42,43)] p-7 flex flex-col justify-between h-[200px]">
                ...
                <motion.a
                  href="/contact-us"
                  className="inline-flex items-center justify-center gap-2 w-full py-3.5 rounded-full border border-[rgba(255,255,255,0.12)] text-white text-sm font-semibold uppercase tracking-wider hover:border-[rgba(255,255,255,0.3)] hover:bg-[rgba(255,255,255,0.03)] transition-all"
