  ...
  return (
    <section className="relative w-full py-28 bg-black-light">
      <div ref={ref} className="max-w-[1200px] mx-auto px-5">
        <div
          className="rounded-3xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] p-10 md:p-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center transition-all duration-700"
