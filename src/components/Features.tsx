...
import { Reveal, StaggerContainer, StaggerItem, fadeLeft, popIn } from "@/components/motion";

export default function Features() {
  return (
    <section id="features" className="relative w-full py-28 bg-[rgb(0, 0, 0)] overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <StaggerContainer staggerDelay={0.18} className="flex flex-col gap-4">
                ...
                <div className="relative rounded-[20px] border border-[rgba(255,255,255,0.06)] bg-[rgb(8,8,10)] p-6 overflow-hidden hover:border-[rgba(232,86,0,0.2)] transition-colors duration-500">
                  ...
                  <div className="flex items-center relative">
                    ...
                    <div className="relative w-12 h-[2px] mx-1">
                      ...
                      <motion.div
                        className="absolute top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-accent-orange"
                        animate={{ x: [0, 40, 0] }}
                ...
                <div className="relative rounded-[20px] border border-[rgba(255,255,255,0.06)] bg-[rgb(8,8,10)] p-5 overflow-hidden hover:border-[rgba(232,86,0,0.2)] transition-colors duration-500">
                  ...
                  {[{ name: "Litecoin", pair: "LTC/USD", change: "1.50%", color: "#BFBBBB" }, { name: "Ethereum", pair: "ETH/USD", change: "3.05%", color: "#627EEA" }, { name: "Polkadot", pair: "DOT/USD", change: "2.80%", color: "#E6007A" }].map((c, i) => (
                    <div key={i} className="flex items-center gap-2 py-1.5 border-b border-[rgba(255,255,255,0.04)] last:border-0">
                      ...
                      <span className="text-[10px] text-green-400">{c.change} ↑</span>
                    </div>
                  ))}
                </div>
              </StaggerItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Card 4: Buy Sell Swap */}
              <StaggerItem>
                <div className="relative rounded-[20px] border border-[rgba(255,255,255,0.06)] overflow-hidden hover:border-[rgba(232,86,0,0.2)] transition-colors duration-500" style={{ background: "linear-gradient(160deg, rgba(232,86,0,0.06) 0%, rgba(14,15,17,0.95) 40%)" }}>
                  ...
                  <div className="grid grid-cols-4 gap-3 p-4">
                    {["▼","N","▲","T","✦","V","T","≡","M","✦","⬡","T"].map((s, i) => (
                      <motion.div
                        ...
                        transition={{ duration: 2.5 + (i % 5) * 0.4, repeat: Infinity, ease: "easeInOut", delay: (i % 4) * 0.3 }}
                      >
