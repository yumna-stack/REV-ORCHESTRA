      ...
      >
        <div className="relative rounded-2xl overflow-hidden border border-[rgba(255,255,255,0.06)] bg-[rgba(20,20,22,0.9)]">
          ...
          <div className="flex items-center gap-6 px-6 py-4 border-b border-[rgba(255,255,255,0.06)]">
            ...
            <span className="text-sm font-medium text-white border-b-2 border-accent-orange pb-1">Command Center</span>
            <span className="text-sm text-[rgba(255,255,255,0.3)]">Signals</span>
            <span className="text-sm text-[rgba(255,255,255,0.3)]">Pipeline</span>
            <span className="text-sm text-[rgba(255,255,255,0.3)]">Agents</span>
          </div>
