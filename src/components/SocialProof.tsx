...
const communityQuotes = [
  ...
  {
    text: "Outbound isn\u2019t dead. Volume based, untriggered, spray and pray outbound is dead. Teams using signals are getting 8 to 12% reply rates. The rest are at 1%.",
        ...
        {orbitItems.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
            >
              <div className="w-8 h-8 rounded-lg bg-[rgb(8,8,10)] border border-[rgb(41,42,43)] flex items-center justify-center text-[7px] font-bold text-[rgba(255,255,255,0.4)]">
                {item.icon}
              </div>
            </motion.div>
          );
            ...
            <motion.div
              className={`w-5 h-5 rounded-full flex items-center justify-center transition-all duration-500 ${
                isActive
                  ...
                  : "bg-[rgb(8,8,10)] border border-[rgba(255,255,255,0.08)]"
              }`}
...
function GlassCard({ children, index, glowColor = "#9897FF" }: { children: React.ReactNode; index: number; glowColor?: string }) {
  return (
    <motion.div
      className="rounded-2xl p-[5px] border border-[rgba(255,255,255,0.03)]"
                      ...
                      <div className="flex gap-5">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-[rgba(255,255,255,0.3)] tracking-wide">
                            {communityQuotes[activeQuote].source}
                          </span>
                        </div>
                      </div>
                    </div>
